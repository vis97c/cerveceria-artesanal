...
Si no cuenta con el ejecutable, la aplicación se puede iniciar al ejecutar el archivo app.py, ya sea desde la consola o desde el IDLE.
...
El ejecutable es compatible con sistemas windows
